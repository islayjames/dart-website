    ...
    <div>
      <header className="page-header">
        <div className="container">
          <div className="eyebrow">Learn / FAQ</div>
          <h1 style={{ marginTop: 12 }}>Everything we get asked. <span style={{ color: 'var(--gold)' }}>Answered plainly.</span></h1>
          <p className="lead" style={{ marginTop: 18 }}>
            Substantive answers about Lightning Lane, My Disney Experience, Dart's pricing and beta program,
            and how all of it fits together. Tap a question to expand.
          </p>
        </div>
      </header>
      ...
      <section className="section">
        <div className="container-narrow">
          {FAQ_ENTRIES.map(([q, a], i) => (
            <div key={q} className={`faq-item ${openIdx === i ? 'open' : ''}`}>
...
// Schema.org JSON-LD for FAQ — production-ready
const FAQSchema = () => (
