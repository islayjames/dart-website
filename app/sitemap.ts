...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/trip-pass`,                  lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.85 },
    { url: `${base}/first-time-disney-world`,    lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/disney-world-with-kids`,     lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/lightning-lane-help`,        lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/dining-mobile-order-help`,   lastModified: LAST_UPDATED, changeFrequency: 'monthly', priority: 0.8 },
